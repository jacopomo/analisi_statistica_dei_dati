...
ax.plot(xx, gaussian_1, label=r'$\mathcal{N}(x; \mu, \sigma_1)$', lw=2.0, linestyle=':')
ax.plot(xx, gaussian_2, label=r'$\mathcal{N}(x; \mu, 3\sigma_1)$', lw=2.0, linestyle='--')
ax.plot(xx, prob, label=r'$p(x; \mu, \sigma_1, f=0.05)$', lw=2.0)
