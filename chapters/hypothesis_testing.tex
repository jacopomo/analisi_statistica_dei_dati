...
\begin{theorem}
	The statistic $\lambda(x)$ has (under the null hypothesis $H_0$), the asymptotic distribution of a $\chi^2_d$ where $d$ is the dimension of $\mu$. the number of free parameters.
\end{theorem}
