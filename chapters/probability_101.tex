...
\end{example}
\todo{We should make clear that the variable that follows this universal gaussian is $y_n=\sqrt{n}(\bar x -\mu)$. So that when we compute the variance for $\bar x$ turns out to depend on $\frac{1}{\sqrt{n}}$ as we expect.}
