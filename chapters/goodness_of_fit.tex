...
\begin{example}
	To demonstrate the danger of using the maximum Likelihood as a GOF indicator, consider a set of $n$ observations $\{x_i\}$ sampled from a Uniform distribution in the interval $[0, m]$. The \emph{pdf} is:
